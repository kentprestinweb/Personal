      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a
                    ...
                    className="text-dark-400 hover:text-teal-400 transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {content?.linkedin_url && (
                <a 
                  ...
                  className="w-10 h-10 bg-dark-800 hover:bg-teal-500 rounded-lg flex items-center justify-center transition-colors"
                >
              ...
              {content?.twitter_url && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-dark-800 hover:bg-electric-blue-500 rounded-lg flex items-center justify-center transition-colors"
                >
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {content?.contact_email && (
              <p className="text-dark-400 mt-4">
                <a href={`mailto:${content.contact_email}`} className="hover:text-teal-400 transition-colors">
                  {content.contact_email}
                </a>
              </p>
            )}
        ...
        <div className="mt-12 pt-8 border-t border-dark-800">
          <p className="text-center text-dark-500 text-sm flex items-center justify-center gap-1">
            {content?.footer_copyright || `© ${currentYear} Kent Angelo Prestin. All rights reserved.`}
            <span className="mx-2">|</span>
            Made with <Heart size={14} className="text-coral-500" /> in Australia
          </p>
        </div>
      </div>
    </footer>
